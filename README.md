...
| Repo | What it does |
|------|-------------|
| [resume-gen](https://github.com/zew1me/resume-gen) | Obsidian vault → SQLite → LLM keyword optimization → PDF resume pipeline |
...
| [macbookair-dotfiles](https://github.com/zew1me/macbookair-dotfiles) | Reproducible Mac setup: Brewfile, dotfiles manifest, install scripts |
